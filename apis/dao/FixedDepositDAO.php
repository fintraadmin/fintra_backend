...
Class FixedDepositDAO extends DAOBase {
	private $table = 'facts';
	private $table_trans = 'facts_translations';
	public $fields = array ('bank_name' => 'id' , 'language' => 'language' , 'bank_name'=> 'title' ,  'rate' => 'description' );
	...
	public function getByID($id, $ln = 'en') {
		$sql = "select * , 'en' as language from fixed_deposit_data where id= '$id' ";
		error_log("sql $sql ");
