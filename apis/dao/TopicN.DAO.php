...
Class TopicNDAO extends DAOBase {
	private $table = 'topics';
	private $table_trans = 'topics_translations';
	public $fields = array ('topic_id'=> 'id' , 'language_code' => 'language' , 'title' => 'title' , 'image' => 'image' , 'seo_title' => 'seo_title' , 'seo_description' => 'seo_description');
	public $type = 'topic';
	...
	public function getTopics($topicid, $ln = 'en'){
	}
