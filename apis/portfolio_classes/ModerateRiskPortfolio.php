...
class ModerateRiskPortfolio extends PortfolioBase{

        public function __construct($params){
                $this->debtPercent = 0.42;
                $this->equityPercent =  0.3;
                $this->balancedPercent =  0.28;
	...
	public function deductAmt(){
        ...
        public function getPortfolio(){
       		//Check if equity amount can be made zero
                ...
                $debtRem = $this->roundUp($this->debtAmount , 500 , 500);
		...
		//TODO
		if($this->balancedAmount == 0 && $this->totalAmount == 500)
			$this->balancedAmount = 500;
