...
class FDCalculator extends BaseCalculator{
	var $principal;
	var $rate ;
	var $time;
	var $amount;
	...
	public function output($params){
		...
		$id = $params['id'];
		$this->amount = ceil(MathFunctions::amount_compound_interest($this->principal , $this->rate , $this->time));
		$this->interest = ceil(MathFunctions::compound_interest($this->principal , $this->rate , $this->time));
