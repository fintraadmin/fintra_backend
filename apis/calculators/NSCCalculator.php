...
class NSCCalculator extends BaseCalculator{
	var $principal;
	var $rate ;
	var $time;
	var $amount;
	...
	public function output($params){
		...
		$this->rate = 7.7;
		$id = $params['id'];
		$this->amount = MathFunctions::amount_compound_interest($this->principal , $this->rate , $this->time ,1);
		$this->interest = MathFunctions::compound_interest($this->principal , $this->rate , $this->time, 1);
